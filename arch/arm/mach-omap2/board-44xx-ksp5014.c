/*
 * Board support file for Phytec KSP-5014 Board.
 *
...
#define KSP5014_ETH_GPIO_IRQ		121
#define KSP5014_ETH_CS			5
#define KSP5014_FT5x06_GPIO_IRQ		107
#define KSP5014_FT5x06_GPIO_WAKE	108
#define KSP5014_LCD_ENABLE		171
#define KSP5014_CAM_PWDN		111
#define KSP5014_RTC_IRQ			117
#define KSP5014_ADXL34X_IRQ1		175
#define KSP5014_ADXL34X_IRQ2		176
#define KSP5014_ADXL34X_IRQ		KSP5014_ADXL34X_IRQ1
#define KSP5014_USBB1_PWR		101
...
static struct gpio_keys_platform_data ksp5014_gpio_keys_data = {
	.buttons	= ksp5014_gpio_keys,
	.nbuttons	= ARRAY_SIZE(ksp5014_gpio_keys),
};

static struct platform_device ksp5014_gpio_keys_device = {
	.name	= "gpio-keys",
	.id = -1,
	.dev	= {
		.platform_data	= &ksp5014_gpio_keys_data,
	},
};
...
static struct platform_pwm_backlight_data ksp5014_backlight_data = {
	.pwm_id         = 0,
	.max_brightness = 255,
	.dft_brightness = 127,
	.pwm_period_ns  = 1000,
...
static struct platform_device ksp5014_backlight_device = {
	.name   = "pwm-backlight",
	.id	= -1,
	.dev    = {
...
static struct omap_abe_wm8974_data ksp5014_abe_audio_data = {
	.card_name = "KSP5014",
	.mclk_freq = 12288000,
};


static struct platform_device ksp5014_abe_audio_device = {
	.name		= "omap-abe-wm8974",
	.id		= -1,
	.dev = {
		.platform_data = &ksp5014_abe_audio_data,
        },
};
...
{
	omap_mux_init_gpio(KSP5014_ETH_GPIO_IRQ, OMAP_PIN_INPUT);
...
//	&omap_vwlan_device,
//	&omap_vedt_device,
	&ksp5014_abe_audio_device,
	&leds_gpio,
	&ksp5014_gpio_keys_device,
	&pwm_device,
	&ksp5014_backlight_device,
};
...
static struct ft5x0x_ts_platform_data pba_ft5x06_pdata = {
	...
	.wake_pin	= KSP5014_FT5x06_GPIO_WAKE,
};
#endif
...
static struct i2c_board_info __initdata pcm049_i2c_4_boardinfo[] = {
#ifdef CONFIG_TOUCHSCREEN_FT5X06
	{
		...
		.irq = OMAP_GPIO_IRQ(KSP5014_FT5x06_GPIO_IRQ),
...
#ifdef CONFIG_INPUT_ADXL34X_I2C
        {
                ...
                .irq = OMAP_GPIO_IRQ(KSP5014_ADXL34X_IRQ),
...
static int __init pcm049_i2c_init(void)
{
	...
	/* RTC-8564 IRQ mux */
	omap_mux_init_gpio(KSP5014_RTC_IRQ, OMAP_PIN_INPUT);
...
{
	return gpio_direction_output(KSP5014_LCD_ENABLE, 1);
}

static void pcm049_panel_disable_lcd(struct omap_dss_device *dssdev)
{
	gpio_direction_output(KSP5014_LCD_ENABLE, 0);
}
...
static const struct usbhs_omap_board_data usbhs_bdata __initconst = {
	...
	.phy_reset  = 1,
	.reset_gpio_port[0]  = KSP5014_USBB1_PWR,
...
static void __init pcm049_display_init(void)
{
	...
	omap_mux_init_gpio(KSP5014_LCD_ENABLE, OMAP_PIN_OUTPUT);

	if ((gpio_request(KSP5014_LCD_ENABLE, "DISP_ENA") == 0) &&
		(gpio_direction_output(KSP5014_LCD_ENABLE, 1) == 0)) {
		gpio_export(KSP5014_LCD_ENABLE, 0);
		gpio_set_value(KSP5014_LCD_ENABLE, 0);
	} else
...
static inline void __init ksp5014_btwilink_init(void)
{
	pr_info("ksp5014: bt init\n");
...
static void __init ksp5014_init_early(void)
{
	omap4430_init_early();
	if (cpu_is_omap446x())
